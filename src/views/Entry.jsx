...
module.exports = function ({ title, user, voteOne, votesObj }) {
        ...
        <Layout isAuth={user}>
            <div className="card w-75 mx-auto" style={{ width: `${26}rem` }}>
                ...
                {voteOne ?
                    ...
                    <div>
                        <h1>Всего голосов {votesObj.pro+votesObj.against}</h1>
                        {votesObj.pro===0 && votesObj.against===0 ?  ( ''):(<h4>Голосов за {Math.round(((votesObj.pro)/(votesObj.pro+votesObj.against))*100)}%</h4>) }
                    </div>
            </div>
